...
SABESP: Lista de Instalações segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [contas_sabesp_lista_instal@mcp.ai](mailto:contas_sabesp_lista_instal@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
